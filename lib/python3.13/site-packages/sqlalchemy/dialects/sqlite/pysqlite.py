...
import os
import re
from typing import (TYPE_CHECKING, Any, Callable, Optional, Pattern, TypeVar,
                    Union, cast)
...
if TYPE_CHECKING:
    from ...engine.interfaces import (ConnectArgsType, DBAPIConnection,
                                      DBAPICursor, DBAPIModule, IsolationLevel,
                                      VersionInfoType)
    from ...engine.url import URL
    from ...pool.base import PoolProxiedConnection
    from ...sql.type_api import _BindProcessorType, _ResultProcessorType
